                                    ...
                                    <table class="table table-sm table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style='font-weight: bold; width: 5%;font-family: "Times New Roman", Times, serif'>Quantity</th>
                                                <th style='font-weight: bold; width: 5%;font-family: "Times New Roman", Times, serif'>Rate</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5" style="vertical-align: middle; text-align: center;">
                                                    <div class="form-group">
                                                        <p class="text-center"><b>{{ this.totalAmount }} </b></p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="5">
                                                    <div class="form-group">
                                                        <p><b>{{ this.totalAmountInWords }} Only </b></p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
...
export default {
    data(){
        return  {
            ...
            form: new form({
                ...
                item_list:
                [{
                    part_number:0, description:'',duration:0,qty:0,rate:0
                }],
            })
        }
    },
    methods:{
        ...
        restForm(){
            ...
            this.form.item_list.push({part_number:'', description:'',duration:'',qty:0,rate:0});
        },
        //adding Info
        addMore: function(){
            this.count++;
            this.form.item_list.push({
                part_number:'', description:'',duration:'',qty:0, rate:0})
        },
        /**
