        ...
        <!-- Header -->
            <div class="report-header">
                ...
                <div class="header-content">
                    <!-- <h1 class="report-title">New Edge Technologies Private Limited</h1> -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5">
                                                ...
                                                <!-- <span id="totalAmount">{{ totalAmountInWords }} only</span> -->
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">
...
export default {
    ...
    methods:{
        //method to convert into pdf and print
        async generatePDF() {
            try {
                ...
                const pdfContent = element.cloneNode(true); // Clone the content to avoid modifying the original

                // Modify the cloned content if needed before generating the PDF

                const pdf = await html2pdf().from(pdfContent).set(pdfOptions).outputPdf();
